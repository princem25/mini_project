        ...
        <body>
           ...
           <a href="/mini_project/view/admin/dashboard.php">Admin</a> | 
                ...
                $(document).ready(function() {
                    ...
                    $("#btn").click(function() {
                        ...
                        if (tourid == "" || teamid == "") {
                            ...
                            $.post("/mini_project/controller/team/assign.php", {
                                    tourid,
                                    teamid
                                },
                                function(response) {
            ...
            <script>
                ...
                function loadTeams() {
                    $.get("/mini_project/controller/team/available.php", function(response) {
            ...
            <?php require_once('C:/xampp_3/htdocs/mini_project/view/tournament/nonverified.php') ?>
